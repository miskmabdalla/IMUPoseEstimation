...
# Inspiration from https://github.com/hbldh/bleak/issues/345
# https://github.com/hbldh/bleak/blob/develop/examples/two_devices.py
# ? Maybe multithreading approach https://stackoverflow.com/questions/28492103/how-to-combine-python-asyncio-with-threads
